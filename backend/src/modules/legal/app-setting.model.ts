...
export interface AppSettingDocument {
  key: string;
  privacyPolicy: LegalPolicyDocument;
  deleteAccountPolicy: LegalPolicyDocument;
  cancellationRefundPolicy: LegalPolicyDocument;
  updatedAt?: Date;
  createdAt?: Date;
}

const policySchema = new Schema<LegalPolicyDocument>(
  {
...
export const AppSetting = model<AppSettingDocument>(
  "AppSetting",
  appSettingSchema,
);
